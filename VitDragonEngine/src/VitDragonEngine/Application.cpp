...
#define BIND_EVENT_FN(x) std::bind(&Application::x, this, std::placeholders::_1)
	...
	VitDragonEngine::Application::Application()
		...
		std::shared_ptr<IndexBuffer> squareID;
		squareID.reset( IndexBuffer::Create( squareIndices, sizeof( squareIndices ) / sizeof( uint32_t ) ) );
		...
		m_BlueShader.reset( new Shader( BlueVertex, BlueFragment ) );
	}
